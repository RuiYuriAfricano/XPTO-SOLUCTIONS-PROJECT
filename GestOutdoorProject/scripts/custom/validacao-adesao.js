...
function validarFormulario() {
    ...
    if (nome === '') {
        ...
        alert('Por favor, insira apenas nomes válidos no campo "Nome completo/Nome da empresa".');
        return false;
    }
    ...
    if (atividade === '') {
        alert('Por favor, preencha o campo "Atividade da empresa".');
        return false;
    }
...
var botaoEnviar = document.querySelector('button[name="submitAdesao"]');
